...
<section>
  <div class="container mx-auto p-4 mt-4">
    <div class="text-center text-3xl mb-4 font-bold border border-gray-300 p-3">
      <!-- Display 'All Jobs' OR search criteria if available -->
      <?php if (isset($keywords) || isset($location)) : ?>
        Search Results For: <?= ($keywords) ? $keywords : '' ?> <?= ' ' .  ($location) ? $location : '' ?>
      <?php else : ?>
        All Jobs
    </div>
  <?php endif; ?>
  <!-- Show flash message if available, then unset message -->
